...
fn test_reconfiguration() {
    ...
    let root_account_state_view2 = AccountStateView::new(
        &root_address,
        get_state_value_resolver_for_version(db.reader.clone(), current_version),
    );
